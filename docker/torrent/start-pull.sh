docker compose -f ./gluetun/docker-compose.yml pull
...
docker compose -f ./qbittorrent/docker-compose.yml pull
docker compose -f ./qbittorrent/docker-compose.yml up -d

docker compose -f ./prowlarr/docker-compose.yml pull
docker compose -f ./prowlarr/docker-compose.yml up -d

docker compose -f ./radarr/docker-compose.yml pull
